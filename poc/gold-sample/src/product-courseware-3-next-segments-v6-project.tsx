...
const scene = makeScene2D('product-courseware-3-next-segments-v6', function* (view) {
  ...
  const tabletBubble = createRef<Rect>();
  const bottleBubble = createRef<Rect>();
  ...
  const introSilhouette = createRef<Img>();
  ...
  const schoolgirl = createRef<Img>();
  const chronic = createRef<Img>();
  const caption = createRef<Txt>();

  view.add(<>
    <Img ref={background} src={'/product-courseware-3-v6/white-silk-bg-v6.png'} size={[1920, 1080]} />
    <Audio src={'/product-courseware-3-v6/next-segments-audio-v6.wav'} play />
    ...
    <Rect ref={safety} size={[1920, 1080]} opacity={0}>
      ...
      <Img ref={safetyPack} src={'/product-courseware-3-v6/package-cluster-alpha.png'} position={[0, 140]} size={[660, 372]} opacity={0} scale={0.72} />
      <Rect ref={lowRate} position={[-680, 130]} size={[390, 390]} opacity={0}>
        <Img src={'/product-courseware-3-v6/child-safety-alpha.png'} position={[0, -35]} size={[310, 310]} />
        <Txt text={'呕吐率低'} position={[0, 155]} width={390} textAlign={'center'} fontFamily={FONT} fontSize={58} fontWeight={900} fill={NAVY} />
      </Rect>
      <Img ref={shield} src={'/product-courseware-3-v6/safety-shield-alpha.png'} position={[690, 80]} size={[270, 270]} opacity={0} />
      <Txt text={'安全性良好'} position={[690, 285]} width={390} textAlign={'center'} fontFamily={FONT} fontSize={47} fontWeight={900} fill={NAVY} />
    </Rect>
    ...
    <Rect ref={dosage} size={[1920, 1080]} opacity={0}>
      <Rect ref={tabletStage} position={[-650, 140]} size={[500, 545]} radius={24} fill={'#FFFFFFE8'} stroke={NAVY} lineWidth={5} opacity={0}>
        <Img ref={tablets} src={'/product-courseware-3-v6/tablets-alpha.png'} position={[0, 60]} size={[420, 280]} opacity={0} scale={0.65} />
        <Rect ref={tabletBubble} position={[0, -145]} size={[420, 245]} opacity={0} scale={0.70}>
          <Img src={'/product-courseware-3-v6/speech-bubble-alpha.png'} size={[420, 245]} />
          <Txt text={'片剂无味\n药小易吞'} position={[0, -12]} width={300} textAlign={'center'} fontFamily={FONT} fontSize={42} lineHeight={52} fontWeight={900} fill={NAVY} />
        </Rect>
      </Rect>
      <Circle position={[0, 130]} size={[700, 540]} fill={'#FFFFFF00'} stroke={ORANGE} lineWidth={5} />
      <Img ref={dosagePack} src={'/product-courseware-3-v6/package-cluster-alpha.png'} position={[0, 140]} size={[620, 350]} opacity={0} scale={0.70} />
      ...
      <Rect ref={bottleStage} position={[650, 140]} size={[500, 545]} radius={24} fill={'#FFFFFFE8'} stroke={NAVY} lineWidth={5} opacity={0}>
        <Img ref={bottles} src={'/product-courseware-3-v6/suspension-bottles-alpha.png'} position={[0, 65]} size={[300, 390]} opacity={0} scale={0.65} />
        <Rect ref={bottleBubble} position={[0, -145]} size={[390, 225]} opacity={0} scale={0.70}>
          <Img src={'/product-courseware-3-v6/speech-bubble-alpha.png'} size={[390, 225]} />
          <Txt text={'草莓口味'} position={[0, -12]} width={300} textAlign={'center'} fontFamily={FONT} fontSize={45} fontWeight={900} fill={NAVY} />
        </Rect>
        <Txt text={'可按体重精准给药'} position={[0, 225]} width={470} textAlign={'center'} fontFamily={FONT} fontSize={31} fontWeight={900} fill={NAVY} />
      </Rect>
    </Rect>
    ...
    <Rect ref={audienceIntro} size={[1920, 1080]} opacity={0}>
      <Img ref={introSilhouette} src={'/product-courseware-3-v6/person-silhouette-alpha.png'} position={[-430, 145]} size={[360, 540]} opacity={0} />
    ...
    <Rect ref={audienceFinal} size={[1920, 1080]} opacity={0}>
      ...
      <Rect ref={audienceCards[0]} position={[-620, 145]} size={[510, 570]} radius={25} fill={'#FFFFFFE8'} stroke={'#E5E7EB'} lineWidth={2} opacity={0}>
        <Img ref={elder} src={'/product-courseware-3-v6/elder-alpha.png'} position={[0, -40]} size={[290, 435]} />
      ...
      <Rect ref={audienceCards[1]} position={[0, 145]} size={[510, 570]} radius={25} fill={'#FFFFFFE8'} stroke={'#E5E7EB'} lineWidth={2} opacity={0}>
        <Img ref={schoolgirl} src={'/product-courseware-3-v6/schoolgirl-alpha.png'} position={[0, -40]} size={[290, 435]} />
      ...
      <Rect ref={audienceCards[2]} position={[620, 145]} size={[610, 570]} radius={25} fill={'#FFFFFFE8'} stroke={'#E5E7EB'} lineWidth={2} opacity={0}>
        <Img ref={chronic} src={'/product-courseware-3-v6/chronic-group-alpha.png'} position={[0, -35]} size={[520, 390]} />
  ...
  function* safetyMotion() {
    ...
    yield* waitFor(1.95);
    lowRate().position.x(-780);
    yield* all(lowRate().opacity(1, 0.18), lowRate().position.x(-650, 0.34, easeOutCubic), lowRate().scale(1.03, 0.34, easeOutBack));
    yield* waitFor(0.55);
    yield* all(shield().opacity(1, 0.16), shield().scale(1.05, 0.28, easeOutBack), shield().rotation(-7, 0.28, easeOutBack));
    yield* waitFor(2.14);
  }
  ...
  function* dosageMotion() {
    ...
    yield* waitFor(0.45);
    yield* all(tabletBubble().opacity(1, 0.15), tabletBubble().scale(1, 0.28, easeOutBack), tabletBubble().rotation(-4, 0.28, easeOutBack));
    yield* waitFor(2.17);
    yield* bottleStage().opacity(1, 0.16);
    yield* all(bottles().opacity(1, 0.12), bottles().scale(1, 0.32, easeOutBack));
    yield* waitFor(0.45);
    yield* all(bottleBubble().opacity(1, 0.15), bottleBubble().scale(1, 0.28, easeOutBack), bottleBubble().rotation(4, 0.28, easeOutBack));
    yield* waitFor(5.23);
  }
  ...
  function* audienceMotion() {
    yield* waitFor(28.20);
    introSilhouette().position.x(-560);
    yield* all(introSilhouette().opacity(1, 0.16), introSilhouette().position.x(-430, 0.42, easeOutCubic), ageBadge().opacity(1, 0.16), ageBadge().scale(1, 0.38, easeOutBack));
    yield* waitFor(6.28);
    audienceCards.forEach((card) => card().position.y(195));
