    ...
    <>
      <Rect ref={mainStage} size={[1920, 1080]} opacity={1}>
        ...
        <Rect key={'editable:q10:summary:table'} ref={table} position={[-40, 38]} size={[1720, 620]} opacity={0} scale={0.84}>
          <Cell x={-676} y={-260} w={330} h={78} text={'核心功效'} header />
          <Cell x={-310} y={-260} w={402} h={78} text={'产品特点'} header />
          <Cell x={140} y={-260} w={498} h={78} text={'适宜人群'} header />
          <Cell x={594} y={-260} w={410} h={78} text={'联合用药'} header />
          <Cell x={-676} y={-112} w={330} h={218} text={'促进能量生成'} size={33} />
          <Cell x={-676} y={118} w={330} h={242} text={'抗氧化，减少\n组织细胞损伤'} size={32} />
          <Cell x={-310} y={-112} w={402} h={218} text={'原研工艺，锁住活性'} size={31} />
          <Cell x={-310} y={74} w={402} h={154} text={'海外原料，提升品质'} size={31} />
          <Cell x={-310} y={234} w={402} h={166} text={'医疗背书'} size={31} />
          <Cell x={140} y={-112} w={498} h={218} text={'顽固心慌、胸闷、气短\n的心血管人群'} size={31} />
          <Cell x={140} y={74} w={498} h={154} text={'常服他汀\n出现肌肉疲劳、疼痛的人群'} size={29} />
          <Cell x={140} y={234} w={498} h={166} text={'备孕男女'} size={31} />
          <Cell x={594} y={-112} w={410} h={218} text={'复方丹参滴丸＋\n辅酶Q10'} size={31} />
          <Cell x={594} y={152} w={410} h={384} text={'他汀＋辅酶Q10'} size={31} />
        </Rect>
        <Rect key={'editable:q10:summary:slogan'} ref={slogan} position={[-25, 425]} size={[1710, 110]} opacity={0} scale={0.86}>
          <Txt position={[-520, 0]} text={'大参林'} fontFamily={FONT} fontSize={72} fontWeight={950} fill={DASHENLIN.primary} stroke={'#ffffff'} lineWidth={4} />
          <Txt position={[220, 4]} text={'内部培训 · 辅酶Q10 商品知识'} fontFamily={FONT} fontSize={48} fontWeight={900} fill={'#ffffff'} stroke={'#101820'} lineWidth={5} />
        </Rect>
        <DashenlinInternalNotice />
      </Rect>
