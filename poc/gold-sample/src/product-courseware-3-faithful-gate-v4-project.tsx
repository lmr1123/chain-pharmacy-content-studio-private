...
const scene = makeScene2D('product-courseware-3-faithful-gate-v4', function* (view) {
  ...
  view.add(<>
    ...
    <Audio src={'/product-courseware-3-v3/new-recording-gate-13.10-40.70-v4.wav'} play />
    <Ribbon />
    <Brand />
