...
<div class="shell">
  ...
  <section class="card" id="step-1">
    <h1>开始使用</h1>
    <p class="lead">
      本包按开源项目「先看清 → 再选用 → 再填报 → 再提交」组织。
      你与 <strong style="color:#fff">WorkBuddy</strong> 协作：你选模板并填 Word，WorkBuddy 出初稿与成片。
    </p>
    <ol class="steps-list">
      <li><strong style="color:#fff">预览并选择模板</strong> — 看封面与关键页，确认观感</li>
      <li><strong style="color:#fff">下载空白 Word 填报</strong> — 可删节，有几条写几条</li>
      <li><strong style="color:#fff">上传提交</strong> — 把已填 Word + 授权图放进提交箱，复制口令发给 WorkBuddy</li>
    ...
    <p class="note">无需安装 Node / 起端口。医学结论与包装以公司审核稿与授权素材为准。</p>
  </section>
