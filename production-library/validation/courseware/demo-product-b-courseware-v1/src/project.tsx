      ...
      <Rect ref={featShell} size={[1920, 1080]} opacity={0}>
        ...
        <Rect ref={f1} size={[1920, 1080]} opacity={0}>
          ...
          <Circle
            ...
            shadowBlur={28}
          >
            <Img ref={packHero} src={A.packGroup} position={[0, 0]} size={[520, 380]} />
          </Circle>
        ...
        <Rect ref={f2} size={[1920, 1080]} opacity={0}>
          ...
          {/* center pack hero — always on when F2 visible */}
          <Circle
            position={[0, 20]}
            size={[440, 440]}
            fill={WHITE}
            ...
            shadowBlur={28}
          >
            <Img src={A.packGroup} size={[360, 270]} />
          </Circle>
          <Line
            ref={tabLine}
            points={[
      ...
      <Rect ref={comboShell} size={[1920, 1080]} opacity={0}>
        ...
        <Rect ref={c1} size={[1920, 1080]} opacity={0}>
          ...
          <Rect ref={comboStage1} position={[0, 80]} size={[1600, 480]} radius={28} fill={'rgba(255,255,255,0.96)'}>
            <Img src={A.packGroup} position={[-360, 0]} size={[560, 400]} />
